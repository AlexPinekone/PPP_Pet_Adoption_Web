<?php
	...
	if(isset($_POST['adminPost'])) {
        ...
        header("Location: administrar.php?idU=$idUsuario");
    }
	
	if(isset($_POST['verChats'])) {
        
		$idUsuario=$_SESSION['idUsuario'];
        header("Location: verChats.php?idU=$idUsuario");
    }
					...
					<div class="infoP">
						...
						<div class="user-details">
							...
							<form id="logoutForm" method="POST">
								<button type="submit" name="adminPost" id="adminPostBtn">Administrar Posts</button>
								<br>
								<button type="submit" name="verChats" id="adminPostBtn">Ver Chats</button>
								<br>
								<button type="submit" name="logout" id="cerrarSesionBtn">Cerrar Sesión</button>
							</form>
						</div>
					</div>
				</div>
