<?php
	...
	if (isset($_GET['idP']))
	{
		...
		header("Local: administrar.php?idU=$idU&idP=$idP");
	}
?>
					...
					<h2>Administrar Posts</h2>
						<?php
							if($postsu)
							{
								...
								echo "<th>Eliminar</th>";
								echo "</tr>";
								foreach($postsu as $registro)
								{
									$idP= $registro['idPost'];
									echo "<tr>";
									echo "<td>".$registro['idPost']."</td>";
									echo "<td>".$registro['nombre']."</td>";
									echo "<td>".$registro['sexo']."</td>";
									echo "<td><a href='editarpost.php?idP=$idP' style='text-decoration:underline;'>Editar</a></td>";
									echo "<td><a href='administrar.php?idU=$idU&idP=$idP' style='text-decoration:underline;'>Eliminar</a></td>";
									echo "</tr>";
								}
								echo "</table>";
							}else
